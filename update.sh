...
h3PgGitHash="$(git ls-remote https://github.com/postgis/h3-pg.git heads/main | awk '{ print $1}')"
addressStandardizerGitHash="$(git ls-remote https://github.com/postgis/address_standardizer.git heads/main | awk '{ print $1}')"
